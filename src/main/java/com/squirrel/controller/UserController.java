...
public class UserController {
    ...
    public String home(HttpServletRequest request, Model model) {
        ...
        List<Comments> commentsByUserId = commentsService.getCommentsByUserId(cur_user.getId());
        for (Comments comments : commentsByUserId) {
            Message message = new Message();
            message.setGoodsId(comments.getGoodsId());
            message.setContent(comments.getContent());
            message.setUserName(cur_user.getUsername());
